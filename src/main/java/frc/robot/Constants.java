...
public class Constants {
    ...
    public static class VisionConstants { // Vision Constants
        /* Camera */
        public static final double height = 0.6096; // height of camera from ground in meters
        public static final double angle = Math.toRadians(38); // angle of camera from ground in radians

        public static final double TargetHeight = 2.64; // height of target from ground in meters
